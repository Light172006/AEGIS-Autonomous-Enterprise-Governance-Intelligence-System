...
class RagConfig:
    ...
    def from_env(cls) -> "RagConfig":
        ...
        # Make paths absolute relative to project root when env vars are relative
        data_dir_raw = os.getenv("AEGIS_DATA_DIR")
        data_dir = PROJECT_ROOT / data_dir_raw if data_dir_raw else PROJECT_ROOT / "data"

        vector_db_dir_raw = os.getenv("AEGIS_VECTOR_DB_DIR")
        vector_db_dir = PROJECT_ROOT / vector_db_dir_raw if vector_db_dir_raw else PROJECT_ROOT / "vector_db" / "chroma"
